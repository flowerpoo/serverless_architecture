...
4. Manual Invocation:
   ...
   1. Created 2 instace with tags Auto-start and Auto-stop and start both the instance.
   2. create a lambda function with EC2 FullAccess.
   3. make a python script using boto3 module, test the function and deploy it.
   4. It will stop the instance with Auto-stop yag and start the instance with Auto-start tag.
   5. Done.